        ...
        >
          ...
          /> */}
                ...
                {errors.confirmPassword && (
                    <span className={"shake-hr text-red-500"}> Confirm Password is required</span>
                )}
            </div>
            ...
            <Button
                ...
                type="submit"
                className="mt-10 block h-[2.7rem] border w-full "
            >
                Sign Up
            </Button>
            ...
            <Button
                ...
                variant="default"
                type="submit"
                className="  block h-[2.7rem] border-2 border-black w-1/2 m-auto mt-8  bg-transparent text-black "
            >
