...
const Navber = () => {
    ...
    return (
        <div className=" flex justify-between w-[80%] mx-auto shadow-md px-4 p-1 rounded-2xl bg-white bg-opacity-70 ">
            ...
            <div className="flex p-1 px-2 rounded-2xl bg-white">
                <button
                    onClick={setEnglish}
                    className={`px-4 py-2 rounded transition ${language === "en" ? "bg-black text-white" : "bg-white text-black"
                        }`}
                >
                    EN
                </button>
                <button
                    onClick={setBangla}
                    className={`px-4 py-2 rounded transition ${language === "fn" ? "bg-black text-white" : "bg-white text-black"
                        }`}
                >
                    FN
                </button>
